...
public class LikeController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            List<Goods> goodsList = collectHandle.findGoodsByUser(me, count, limitMin, perPage, sort);
        ...
        request.getRequestDispatcher("/site/personal/like.jsp").forward(request, response);
    }
